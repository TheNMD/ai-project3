...
def calculate_avg_reflectivity(reflectivity,
                               weight_set=[0, 0, 0, 0, 0, 0, 0, 0]):
    # Write the weights to a file
    # if os.path.exists('data/data_WF/weights.txt'):
    #     os.remove('data/data_WF/weights.txt')
    # with open('data/data_WF/weights.txt', 'a') as file:
    #     file.write(f"{weight_set}" + '\n')
    weights = []
    ...
    weight_set = [10 * pow(1, 1 - reflectivity_smaller_than_30), pow(10, 2) * pow(3, 1 - reflectivity_30_to_35),
                  pow(10, 3) * pow(5, 1 - reflectivity_35_to_40),
                  pow(10, 4) * pow(7, 1 - reflectivity_40_to_45),
                  pow(10, 5) * pow(9, 1 - reflectivity_45_to_50), pow(10, 6) * pow(11, 1 - reflectivity_50_to_55),
