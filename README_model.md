...
docker run -v /data/DanHoangThu/image:/app/image -v /data/DanHoangThu/image:/app/model -v /data/DanHoangThu/image:/app/result --shm-size=32g --gpus '"device=0,1"' --name dht-cont dht-image
## Remove image
